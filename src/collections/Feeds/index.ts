...
import { contentTypeOptions } from '../../constants/ContentTypes.js'
import { feedAllowedCollections } from '../../constants/feedAllowedCollections.js'
import { randomBytes } from 'crypto'
import { slugField } from '../../fields/slug.js'

export const createFeedsCollection = (): CollectionConfig => ({
  slug: 'feeds',
  admin: {
    useAsTitle: 'name',
  },
  fields: [
...

    {
      ...
      label: 'Collection',
      type: 'select',
      options: feedAllowedCollections,
      required: true,
    },
